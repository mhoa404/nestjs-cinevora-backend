# FILE: src/database/migrations/1776785591792-AddRoomNameUnique.ts

path: src/database/migrations/1776785591792-AddRoomNameUnique.ts
module: database
kind: migration
language: ts
line_count: 492
size_bytes: 22135
sha256: 6d517f58c011e695c59659eada216e4662b1f456f53f663894741f7263a548f7
updated_at: 2026-04-22T03:40:41.123Z

## SYMBOLS
- AddRoomNameUnique1776785591792
...
export class AddRoomNameUnique1776785591792 implements MigrationInterface {
  name = 'AddRoomNameUnique1776785591792';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`movie_genres\` DROP FOREIGN KEY \`FK_movie_genres_genre\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`movie_genres\` DROP FOREIGN KEY \`FK_movie_genres_movie\``,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`showtimes\` ADD \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`movie_genres\` DROP FOREIGN KEY \`FK_bbbc12542564f7ff56e36f5bbf6\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`movie_genres\` DROP FOREIGN KEY \`FK_ae967ce58ef99e9ff3933ccea48\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_bbbc12542564f7ff56e36f5bbf\` ON \`movie_genres\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_ae967ce58ef99e9ff3933ccea4\` ON \`movie_genres\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`showtimes\` ADD \`created_at\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE \`showtimes\` DROP COLUMN \`end_time\``,
    );
